...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewholder> {
    ...
    CustomAdapter(Context context, ArrayList person_id, ArrayList name, ArrayList age,ArrayList gender){
    ...
    TextView person_id_txt,name_txt,age_txt,gender_txt;
        public MyViewholder(@NonNull View itemView) {
            ...
            gender_txt=itemView.findViewById(R.id.gender);
